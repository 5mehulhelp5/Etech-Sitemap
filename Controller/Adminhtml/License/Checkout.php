...
namespace Etechflow\Sitemap\Controller\Adminhtml\License;
...
{
    public const ADMIN_RESOURCE = 'Etechflow_Sitemap::config';
    ...
    public function execute(): ResultInterface
    {
        ...
        $gate = $this->resultFactory->create(ResultFactory::TYPE_REDIRECT)->setPath('etechflow_sitemap/license/gate');
        ...
        $payload = json_encode([
            ...
            'magento_callback' => $this->getUrl('etechflow_sitemap/license/activated'),
            'magento_cancel'   => $this->getUrl('etechflow_sitemap/license/gate'),
        ]);
