...
namespace Etechflow\Sitemap\Block\Adminhtml\System\Config;
...
/**
 * Status banner at the top of the Sitemap admin config section.
 *
        ...
        if (!$licenceValid) {
            if (!$hasKey) {
                return $this->banner(
                    ...
                    . '<a href="' . $this->getUrl('etechflow_sitemap/license/gate') . '" style="color:inherit;text-decoration:underline;">License &amp; Plans</a> '
                    . 'to purchase one.'
                );
            }
