...
namespace Etechflow\Sitemap\Observer;
...
{
    private const PACKAGE     = 'etechflow/module-sitemap';
    private const LATEST_URL  = 'https://license-service.etechflow.com/composer/latest/etechflow/module-sitemap.json';
    private const CACHE_KEY   = 'etechflow_rs_update_check';
    private const CACHE_TTL   = 21600;
    private const MODULE_NAME = 'Etechflow_Sitemap';
    ...
    public function execute(Observer $observer): void
    {
        try {
            ...
            $title = (string) __('eTechFlow Sitemap %1 is available', $latest['version']);
